...
import sys
sys.path.append("..")
from utils import get_usecases, save_to_excel
...
if __name__ == "__main__":
    ...
    1、以{domain}领域的内容随机生成主题作为title，编写创作500字以上的文章作为content
    ...
    try:
        ...
        while True:
            ...
            for i in range(usecases_cnt):
                ...
                # print(new_question)
                new_content = streamGetGPTAnswer(url, HEADERS, payload, question=new_question)
                # print(new_content)
            ...
            save_to_excel(answers_list, "chatgpt_ru_stream" + current_time, args.output_dir)
